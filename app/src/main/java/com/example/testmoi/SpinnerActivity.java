...
import com.example.testmoi.SpinWheel.LuckyWheelView;
import com.example.testmoi.SpinWheel.model.LuckyItem;
import com.example.testmoi.databinding.ActivitySpinnerBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.spinBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MediaPlayer music = MediaPlayer.create(SpinnerActivity.this, R.raw.spin);
                music.start();
